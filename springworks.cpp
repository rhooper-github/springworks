...
int importJSONFile(Document& d, const char * fname) {
...
void reportEdgeProperties(Route::edge_descriptor ed) {
		cout << endl;
		cout << "=============================" << endl;
...
void reportVertexProperties(Route::vertex_descriptor vd) {
		cout << endl;
		cout << "=============================" << endl;
...
std::string getTimestamp(const int index) {
	Route::vertex_descriptor vd = index;
